...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Ultron Desk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Ultron Desk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Ultron Desk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Ultron Desk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Ultron Desk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Ultron Desk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Ultron Desk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Mantener Ultron Desk como servicio en segundo plano"),
        ...
        ("Show RustDesk", "Mostrar Ultron Desk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Ultron Desk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Ultron Desk permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Ultron Desk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Ultron Desk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza Ultron Desk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Ultron Desk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Ultron Desk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Ultron Desk en segundo plano"),
        ...
        ("About RustDesk", "Acerca de Ultron Desk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Ultron Desk a la versión {} o superior en el lado remoto"),
        ...
        ("printer-requires-installed-{}-client-tip", "Para usar la impresión remota, Ultron Desk necesita estar instalado en tu dispositivo."),
        ("printer-{}-not-installed-tip", "La impresora Ultron Desk no está instalada."),
        ("printer-{}-ready-tip", "La impresora Ultron Desk está instalada y lista para usar."),
        ("Install {} Printer", "Instalar la impresora Ultron Desk"),
